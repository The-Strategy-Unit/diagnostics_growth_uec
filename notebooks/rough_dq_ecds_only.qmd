...
# Data quality in detail {#sec-detail}

As we proceed with the modelling work, we will likely require deeper analysis of specific variables (for an agreed subset of providers). This section can be used to display the results and consequences of these analyses.
...
# dq_provider_represent_ecds_only |>
 #       semi_join(provider_sample, join_by(procode)) |> 
  distinct(procode, trust_name, trust_type) |> 
  gt()
```
