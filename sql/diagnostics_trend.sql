...
-- \__,_|\___|\__,_|
      ...
      WHERE Der_Financial_Year IN (
          ...
          AND -- EXCLUSIONS MIRRORING STEVEN'S PREVIOUS WORK:  (BUT ONLY DEPARTMENT TYPE 1)
          ...
          AND SEX IN ('1', '2') 
          -- EQUIVALENTS TO PAUL'S CLAUSES FROM INDUSTRIAL ACTION CODE:
 ...
 */
      ...
      WHERE ec.Der_Financial_Year IN (
          ...
          AND -- EXCLUSIONS MIRRORING STEVEN'S PREVIOUS WORK (ECDS EQUIVALENTS TO AEA): 
